...
Ing. Agr. **Juan Ramón Rojas** (INTA AER Santa Victoria Este)  
Ing. Agr. **Daniel Lamberti** (INTA AER Perico)  
Tec. RR.HH. **Fátima del Valle Miranda** (INTA AER Palma Sola)  
Ing. Agr. **Florencia Díaz** (INTA AER Palma Sola)
...
def crear_pdf(df_dia, fecha_selec, cant_total):
    ...
    pdf.multi_cell(
        ...
        "Héctor Diaz (INTA AER J.V. Gonzalez), "
        "Carlos G. Cabrera (INTA AER J.V. Gonzalez), "
        "Lucas Diaz (INTA AER Cafayate - OIT San Carlos), "
        "Cristina Rosetto (INTA EECT Yuto), "
